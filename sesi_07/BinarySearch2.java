public class BinarySearch2 {
    ...
    public static void main(String[] args) {
        ...
        int key3 = 8;
        int key4 = 39;
        int i = BinarySearch2.pencarianBinary(myArray, key1);
        int j = BinarySearch2.pencarianBinary(myArray, key2);
        int k = BinarySearch2.pencarianBinary(myArray, key3);
        int l = BinarySearch2.pencarianBinary(myArray, key4);
